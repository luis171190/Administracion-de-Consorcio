...
<div  class="preloader">
   ...
   <div id="logeo" class="" style="width: 100%">
       <h2 class="texto-label center" style="text-decoration:underline">GENERAR PARAMETROS</h2>
       <br>
           <div style="margin:auto">  
<form class="center" action="alta-parametro.php" method="post" >
    <label class="texto-label">Descripcion:</label>
    <input name="descripcion_par" type="text" id="username" required class="box-usuario"><br><br>
      <label class="texto-label">Porcentaje (%):</label>
    <input name="porc" type="text" id="username" required class="box-usuario"><br><br>
