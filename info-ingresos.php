                                  ...
                                  <form action="php/nueva-torre.php" id="form_torre" method="post" class="form-horizontal" onsubmit="return validar();">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-lg-10 col-md-10 col-sm-10">
                                                <input name="fecha_ingreso" type="date" class="form-control" placeholder="Fecha del ingreso" value="" required id="fecha_ingreso">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-xs-12 col-lg-2 col-md-2 col-sm-2">Monto ($):</label>
                                            <div class="col-xs-12 col-lg-10 col-md-10 col-sm-10">
                                                <input type="number" class="form-control" placeholder="Monto del ingreso" value="" name="monto" required id="monto">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-lg-10 col-md-10 col-sm-10">
                                                <input type="text" class="form-control" placeholder="Descripcion del ingreso" value="" name="descripcion" required id="descripcion">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-offset-2 col-xs-10">
                                                <input type="button" class="btn btn-success" value="Guardar" onclick="guardarIngreso();">
...
function guardarIngreso(){
    ...
    $.ajax({
    type: 'POST', 
    url: 'php/nuevo-ingreso.php',
    data:{id_consorcio:id_consorcio, fecha_egreso:fecha, monto:monto, descripcion:descripcion},
