    ...
    if($estado==0)
    {
      ...
      echo ' <p id="contador"><tr><td>'.$c.'</td> </p>
       ...
       <div style="text-align:center">
           ...
           <?php
           if($es_liq!='confirmado')
           { 
               echo '
           <form id="form_aceptar" action="php/aceptar-liq.php" method="post">
               <input type="button" onclick="Confirmar();" value=" ACEPTAR LIQUIDACION" class="btn btn-danger"style="color:white; font-weight: bold;" >
               <input type="hidden" value="'.$idliquidacion.'" name="idliquidacion233">
...
if (confirm('¿Desea aceptar liquidacion?. Se enviaràn emails con el detalle a cada usuario.')){     // preguntar a sergio
