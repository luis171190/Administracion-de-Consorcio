...
<section class="principal"> 
   ...
   <div class="col-xs-10 col-xs-offset-1 col-sm-7 col-sm-offset-3"> 
    ...
    <div class="panel-heading">VER ANUNCIO</div>
                                  ...
                                  <form action="php/actualizar-anuncio.php" id="form_torre" method="post" class="form-horizontal" onsubmit="return validar();">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-lg-10 col-md-10 col-sm-10">
                                                <input name="fecha_anuncio" readonly required type="date" class="form-control"  value="<?php echo $fecha ?>" required id="fecha_anuncio">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-xs-12 col-lg-2 col-md-2 col-sm-2">Título:</label>
                                            <div class="col-xs-12 col-lg-10 col-md-10 col-sm-10">
                                                <input type="text" class="form-control"  readonly name="titulo"  id="titulo_a"  value="<?php echo $titulo ?>" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-lg-10 col-md-10 col-sm-10">
                                                  <textarea   required name="contenido" id="contenido_a" readonly class="form-control" rows="25"   ><?php echo $contenido?></textarea>
                                                <input type="hidden" readonly name="idanuncio" value="<?php echo $idanuncio ?>">
                                            </div>
